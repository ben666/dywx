...
-- ----------------------------
BEGIN;
INSERT INTO `pb_action_log` VALUES (1, 1, 1, 2130706433, 'member', 1, 'admin在2016-04-03 09:45登录了后台', 1, 1459647952);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pb_auth_group` VALUES (3, 'admin', 1, '超级管理员', '所有权限', 1, '1,3,19,20,22,26,27,61,62,63,64,65,66,82,83,84,86,87,88,100,102,103,107,207,212,213,219,220,221,222,223,224,225,226,227,228,229,230,231,232,233,234,235,236,237,238,239,240,241,282,283');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pb_auth_group_access` VALUES (1, 1, 3);
COMMIT;
...
INSERT INTO `pb_auth_rule` VALUES (282, 'admin', 2, 'admin/Wechat/index', '通讯录', 1, '');
INSERT INTO `pb_auth_rule` VALUES (283, 'admin', 2, 'admin/System/index', '系统设置', 1, '');
COMMIT;
...
CREATE TABLE `pb_browse` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `learn_id` int(11) DEFAULT NULL COMMENT '两学一做 id',
  `news_id` int(11) DEFAULT NULL COMMENT '第一聚焦  id',
  `notice_id` int(11) DEFAULT NULL COMMENT '组织活动id',
  `party_id` int(11) DEFAULT NULL COMMENT '三会一课id',
  `affiche_id` int(11) DEFAULT NULL COMMENT '通知公告 id',
...
-- ----------------------------
BEGIN;
INSERT INTO `pb_config` VALUES (1, 'WEB_SITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '伊川乡党建', 0);
INSERT INTO `pb_config` VALUES (2, 'WEB_SITE_DESCRIPTION', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 1, '伊川乡党建', 1);
INSERT INTO `pb_config` VALUES (3, 'WEB_SITE_KEYWORD', 2, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 1, '党建,共产党,', 8);
...
CREATE TABLE `pb_like` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type` tinyint(4) DEFAULT NULL COMMENT '表类别 0评论',
  `table` varchar(50) DEFAULT NULL COMMENT '表名',
  `aid` int(11) DEFAULT NULL COMMENT '文章id',
...
-- ----------------------------
BEGIN;
INSERT INTO `pb_member` VALUES (1, 'admin', 0, '2016-05-23', '', 0, NULL, 1, NULL, NULL, 1519785815, 2130706433, NULL, NULL);
COMMIT;
...
INSERT INTO `pb_menu` VALUES (5, '通讯录', 'fa-users', 0, 11, 'Wechat/index', 0, '', '', 0, 1);
INSERT INTO `pb_menu` VALUES (6, '系统设置', 'fa-cog', 0, 12, 'System/index', 0, '', '', 0, 1);
...
INSERT INTO `pb_menu` VALUES (25, '后台用户', 'fa-user', 0, 13, 'User/index', 0, '', '', 0, 1);
...
INSERT INTO `pb_menu` VALUES (55, '标签', '', 5, 0, 'Wechat/tag', 1, '', '', 0, 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `pb_ucenter_member` VALUES (1, 'admin', '02571bc54a0a4c08451a187d1929b208', '958364865@qq.com', '', 0, 1459647942, 2130706433, 1464224874, 3232235828, 1464224874, 1);
COMMIT;
...
CREATE TABLE `pb_wechat_department` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL COMMENT '部门名称。长度限制为1~64个字节，字符不能包括\\:*?"<>｜',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0为删除 1为正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微信部门表';
...
CREATE TABLE `pb_wechat_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `userid` varchar(33) CHARACTER SET utf8 DEFAULT NULL COMMENT 'openid,也是作为用户唯一的id号',
  `name` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '成员名称',
  ...
  `headimgurl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '/home/images/common/vistor.jpg' COMMENT '用户头像，最后一个数值代表正方形头像大小（有0、46、64、96、132数值可选，0代表640*640正方形头像），用户没有头像时该项为空。若用户更换头像，原有头像URL将失效。',
  ...
  `birthday` varchar(11) CHARACTER SET utf8 DEFAULT NULL COMMENT '出生日期',
  `party` tinyint(1) DEFAULT '0' COMMENT '是否党员   1 是  0 否',
  `partytime` varchar(11) CHARACTER SET utf8 DEFAULT NULL COMMENT '入党时间',
  `education` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '学历',
  `position` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '职位信息',
  `status` tinyint(1) DEFAULT '4' COMMENT '后期逻辑处理标识,4取消关注、1关注',
  `state` tinyint(1) DEFAULT '1' COMMENT '0 为被删除 1为正常',
  `score` int(11) unsigned DEFAULT '0' COMMENT '个人累计积分',
  `review` tinyint(1) DEFAULT '0' COMMENT '审核权限 0为普通党员 1为管理员',
  PRIMARY KEY (`id`)
